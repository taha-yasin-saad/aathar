...
class ElementsKit_Widget_table extends Widget_Base {
    ...
    protected function render_raw( ) {
        ...
        <div class="ekit_table display  ekit_table_data_type-<?php echo esc_attr( $ekit_table_data_type ); ?>" <?php $this->print_render_attribute_string('table'); ?>>
                <?php
                ...
                if($ekit_table_data_type == 'custom'){
                   ...
                   $row_count = 1;
                    foreach((array)$table_body_content as $key => $bodycon){
                        ...
                        // Output: table data 
                        ?>
                            <td data-order="<?php echo wp_strip_all_tags( wp_kses($bodycon['cell_text'], \ElementsKit_Lite\Utils::get_kses_array())); ?>" class="elementor-repeater-item-<?php echo esc_attr($bodycon['_id']); ?> ekit_table_data_<?php echo esc_attr($bodycon['cell_icon_position']); ?>">
