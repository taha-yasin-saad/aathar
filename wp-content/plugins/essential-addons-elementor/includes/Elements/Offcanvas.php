...
class Offcanvas extends Widget_Base
{
    ...
    protected function is_dynamic_content():bool {
		...
		$is_dynamic_content = 'template' === $content_type || 'widget' === $content_type;
            ...
            foreach ($settings['custom_content'] as $key => $item) {
                ...
                <div class="eael-offcanvas-custom-widget">
                    ...
                    <div class="eael-offcanvas-widget-content">
                        <?php echo wp_kses( $item['description'], Helper::eael_allowed_tags() ); ?>
                    </div>
                </div>
                <?php
}
            ...
            <div class="eael-offcanvas-toggle-wrap">
                <div <?php $this->print_render_attribute_string('toggle-button'); ?>>
                    ...
                    <span class="eael-toggle-text">
                        <?php echo wp_kses( $settings['button_text'], Helper::eael_allowed_icon_tags() ); ?>
                    </span>
                </div>
            </div>
