 ...
 */
define( 'BDTPS_CORE_REQUIRED_VERSION', '3.14.0' );
$domain = preg_replace( "(^https?://)", "", site_url() );
update_option('prime_slider_license_key' . "_s" . hash( 'crc32b', $domain ), 'd6d948be-fb90-43bc-840e-fb0e1af2d253');
