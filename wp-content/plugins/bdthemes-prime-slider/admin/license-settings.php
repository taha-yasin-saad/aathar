...
class License_Settings {
	...
	public static function get_license_key() {
		...
		self::set_license_email( base64_decode(Prime_Slider_Base::$mail_id));
		update_option(Prime_Slider_Base::get_lic_key_param('prime_slider_license_key'), base64_decode(Prime_Slider_Base::$ver));
