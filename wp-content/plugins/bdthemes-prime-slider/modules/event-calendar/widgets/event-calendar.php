...
class Event_Calendar extends Widget_Base {
	...
	public function render_meta() {
		...
		if ( 'yes' == $settings['show_buy_button'] ) {
			$this->add_link_attributes( 'button-link', $settings['button_link'] );
		}
			...
			<?php if ( 'yes' == $settings['show_buy_button'] ) : ?>
				<div class="bdt-event-price">
					<?php if ( '' !== $settings['button_link']['url'] ) : ?>
						<a <?php $this->print_render_attribute_string('button-link'); ?>>
						<?php endif; ?>
						<span>
	...
	public function render_header() {
		...
		$this->add_render_attribute( 'swiper', 'class', 'swiper-event-calendar swiper' );
