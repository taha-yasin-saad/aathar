...
class Woohotspot extends Widget_Base {
	...
	public function render_readmore( $marker ) {
		...
		$this->add_render_attribute('product-link', 'class', 'bdt-woohotspot-link elementor-button elementor-size-xs elementor-animation-' . $settings['readmore_hover_animation'], true);
		$this->add_link_attributes( 'product-link', $marker['product_link'], true );
	...
	public function render_two_readmore( $marker ) {
		...
		$this->add_render_attribute( 'product-link', 'class', 'bdt-woohotspot-link elementor-button elementor-size-xs elementor-animation-' . $settings['readmore_hover_animation'], true );
		$this->add_link_attributes( 'product-link', $marker['two_product_link'], true );
	...
	public function render_three_readmore( $marker ) {
		...
		$this->add_render_attribute( 'product-link', 'class', 'bdt-woohotspot-link elementor-button elementor-size-xs elementor-animation-' . $settings['readmore_hover_animation'], true );
		$this->add_link_attributes( 'product-link', $marker['three_product_link'], true );
	...
	protected function render_header() {
		...
		$this->add_render_attribute( 'swiper', 'class', 'swiper-woohotspot swiper' );
