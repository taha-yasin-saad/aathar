...
class Knily extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[ 
				...
				'selectors'  => [ 
					'{{WRAPPER}} .bdt-prime-slider-knily .swiper-knily .bdt-item' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	public function render_category() {
		...
		$post_id = get_the_ID(); // Get current post or product ID
	...
	protected function render_header() {
		...
		$this->add_render_attribute( 'swiper', 'class', 'swiper-knily swiper' );
