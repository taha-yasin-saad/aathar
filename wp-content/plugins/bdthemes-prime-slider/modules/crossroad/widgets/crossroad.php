...
class Crossroad extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'show_counter',
			[ 
				'label'   => esc_html__( 'Show Number', 'bdthemes-prime-slider' ),
				'type'    => Controls_Manager::SWITCHER,
				'default' => 'yes',
			]
		);
		...
		$this->add_responsive_control(
			'header_padding',
			[ 
				'label'      => esc_html__( 'Header Padding', 'bdthemes-prime-slider' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [ 
	...
	public function render_button( $content ) {
		...
		?>
		<?php if ( $content['slide_button_text'] && ( 'yes' == $settings['show_button'] ) && isset($content['button_link']['url']) ) : ?>
